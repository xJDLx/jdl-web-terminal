...
# Updated to match the endpoint structure in your steamdt_api.py
...
# Session State Initialization (Fixed duplicated blocks and merge markers)
            ...
            if not st.session_state.api_key: st.error("Set API Key first")
                ...
                for i, (idx, row) in enumerate(df_raw.iterrows()):
                    ...
                    if data:
                        ...
                        st.warning(f"Sync failed for {row['Item Name']}: {err}")
