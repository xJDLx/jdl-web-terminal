...
def load_portfolio(user_email):
    # Added "Daily Sales" and "Weekly Sales" columns
...
def fetch_steamdt_market_data(item_hash, api_key):
    """Fetches market data including sales volume metrics from the item metadata"""
    try:
        ...
        if r.status_code == 200:
            ...
            # Extract sales metrics from item metadata
            # 'sales24h' or similar keys are typical in SteamDT item objects
